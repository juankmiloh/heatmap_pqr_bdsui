...
function loadEmpresas(select, causas, cod_empresa) {
	...
	// let servicioAntes = localStorage.getItem('servicioAntes');
        var servicio = select;
        var url = "http://172.16.44.250:5055/empresa/"+servicio;
...
function loadCausas(select) { // el select recibe un json con el codigo de empresa y el servicio
        ...
        // var url = "http://172.16.44.250:5055/causas/"+cod_empresa+"/"+servicio+"/"+ano+"/"+mes //url con filtros
        var url = "http://172.16.44.250:5055/causas/"+servicio

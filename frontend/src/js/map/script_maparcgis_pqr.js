...
function visualizar(opcion, datos) {
  ...
  urlPqrsCausas = "http://172.16.44.250:5055/pqr_causas"+"/"+cod_empresa+"/"+servicio+"/"+ano+"/"+mes+"/"+cod_causa;
  ...
  require(
    ...
    function(Map, CSVLayer, MapView, Legend, Search, watchUtils, BasemapToggle, View) {
      const url =
                  ...
                  // "http://172.16.44.250:5055/pqr/empresa/0/glp/2018/1/0";
                  "http://172.16.44.250:5055/pqr/empresa"+"/"+cod_empresa+"/"+servicio+"/"+ano+"/"+mes+"/"+cod_causa;
